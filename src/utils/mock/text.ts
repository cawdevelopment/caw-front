...
export const description = [
  'The journey to #freedom begins when people are self-aware and an #anti-censorship mechanism is in place. When we are able to articulate and identify the problems within our society and take an active role in changing those problems, then we can ultimately be granted freedom. Freedom not only from government suppression of freedom. https://caw.is , $caw and teh @CAWMmunity ...',
  'Occaecati est et illo #quibusdam Go to https://dashboard.alchemy.com/ accusamus qui, @elonmusk is working hard. #Incidunt aut et #molestiae ut www.facere.com aut. Est quidem iusto #praesentium excepturi harum nihil tenetur facilis. Ut omnis voluptates nihil accusantium doloribus eaque #debitis $btc and $caw to the #moon.',
  ...
  'Go to https://dashboard.alchemy.com/ Rerum eius velit dolores. Explicabo ad nemo quibusdam. Voluptatem eum suscipit et ipsum et #consequatur aperiam quia. Rerum nulla sequi recusandae illum velit quia quas. Et error laborum maiores cupiditate occaecati.',
